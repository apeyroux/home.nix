...
myKeys conf@XConfig {XMonad.modMask = modMask} = M.fromList $
  ...
  , ((noModMask, xF86XK_AudioMicMute), spawn "amixer -c 0 sset Capture toggle")
  ...
  , ((noModMask, xF86XK_MonBrightnessUp             ), spawn "light -A 100")
  , ((noModMask, xF86XK_MonBrightnessDown             ), spawn "light -U 100")
